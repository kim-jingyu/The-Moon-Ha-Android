 ...
 * </pre>
 */
class ScheduleWeeklyDialogAdapter(
    private val lessons: List<ScheduleWeeklyResponse>,
    private val fragment: Fragment,
    private val viewModel: LoungeViewModel
) : RecyclerView.Adapter<ScheduleWeeklyDialogAdapter.LessonViewHolder>() {
    ...
    private fun navigateToDetailFragment(item: ScheduleWeeklyResponse) {
